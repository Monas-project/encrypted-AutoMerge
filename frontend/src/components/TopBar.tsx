...
export default function TopBar({ title, onTitleChange, zoom, onZoomChange }: Props) {
    ...
    const inputClassName = "px-1.5 py-[1px] rounded text-lg font-normal leading-[20px] hover:bg-slate-200 focus:bg-white focus:ring-2 focus:ring-blue-300 min-w-0 max-w-[calc(100%-1rem)] overflow-hidden text-ellipsis whitespace-nowrap";
    ...
    return (
        <header className="min-w-screen h-16 flex items-center bg-white/90">
            <div className="h-[36px] aspect-square m-[14px] rounded grid place-items-center bg-blue-600 text-white font-bold">E</div>
            ...
            <div className="ml-auto pl-4 pr-3 flex items-center gap-2 shrink-0">
                ...
                <div className="size-12 aspect-square p-2">
                    <div className="aspect-square rounded-full bg-emerald-500 text-white grid place-items-center">K</div>
                </div>
            </div>
        </header>
    )
