...
describe("EditorService", () => {
  ...
  describe("initializeEditor", () => {
    it("should initialize editor with initial text and cursor position", async () => {
      ...
      expect(console.log).toHaveBeenCalledWith("Editor initialized with text:", initialText, "cursor:", cursorLine)
    })
  ...
  describe("updateText", () => {
    it("should update current text", () => {
      ...
      expect(console.log).toHaveBeenCalledWith("Editor text updated to:", newText)
    })
